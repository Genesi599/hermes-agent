...
export const ja = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      markRead: '既読にする',
      agentActions: 'エージェントの操作',
      export: 'エクスポート',
      branchFrom: '分岐',
      mergeBranch: '親セッションにマージ',
      mergeChildren: count => `子セッションをすべて回収（${count}）`,
      mergeChildrenDeferred: '一部のネストされた分岐は直接の親を待っています。後でもう一度実行してください。',
      mergeChildrenFailed: '一部の子セッションを回収できませんでした',
      mergeBranchTitle: '分岐を親セッションにマージしますか？',
      mergeBranchDesc: 'Hermes は分岐の新しい情報を要約して親セッションに追加し、この分岐を完全に削除します。',
      mergingBranch: 'マージ中…',
      mergedBranch: 'マージ済み',
      rename: '名前を変更',
      archive: 'アーカイブ',
  ...
  modelPicker: {
    ...
    wasPrice: '旧価格',
    applyCurrent: '現在の会話',
    applyCurrentDescription: '現在表示している会話のみ切り替えます。',
    applyAll: 'すべての会話',
    applyAllDescription: 'このプロファイルの全会話を切り替え、新しい会話の既定値に設定します。'
  },
  ...
  desktop: {
    ...
    modelSwitchAllResult: (switched, queued, failed) =>
      `全会話を更新しました：${switched} 件切替、${queued} 件待機、${failed} 件失敗。`,

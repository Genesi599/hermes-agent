...
export const zhHant = defineLocale({
  ...
  sidebar: {
    ...
    row: {
      ...
      export: '匯出',
      branchFrom: '分支',
      mergeBranch: '合併到父工作階段',
      mergeChildren: count => `收回全部子對話（${count}）`,
      mergeChildrenDeferred: '部分多層分支正在等待其直接父對話，請稍後再次執行「收回全部子對話」。',
      mergeChildrenFailed: '部分子對話收回失敗',
      mergeBranchTitle: '將分支合併到父工作階段？',
      mergeBranchDesc: 'Hermes 會彙整分支中的新增資訊並注入父工作階段，然後永久刪除此分支。',
      mergingBranch: '正在合併…',
      mergedBranch: '已合併',
      rename: '重新命名',
      archive: '封存',
  ...
  modelPicker: {
    ...
    wasPrice: '原價',
    applyCurrent: '目前對話',
    applyCurrentDescription: '只切換目前正在檢視的對話。',
    applyAll: '全部對話',

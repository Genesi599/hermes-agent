...
export const zh: Translations = {
  ...
  sidebar: {
    ...
    row: {
      ...
      duplicate: '复制对话',
      mergeBranch: '合并到父会话',
      mergeChildren: count => `收回全部子对话（${count}）`,
      mergeChildrenDeferred: '部分多层分支正在等待其直接父对话，请稍后再次执行“收回全部子对话”。',
      mergeChildrenFailed: '部分子对话收回失败',
      mergeBranchTitle: '将分支合并到父会话？',
      mergeBranchDesc: 'Hermes 会把分支中的新增信息总结并注入父会话，然后永久删除此分支。',
      mergingBranch: '正在合并…',
      mergedBranch: '已合并',
      rename: '重命名',
      archive: '归档',
  ...
  assistant: {
    ...
    thread: {
      ...
      stopReading: '停止朗读',
      readAloud: '朗读',
      channelPlaceholder: '对群里说点什么…',
      channelPost: '发到群里',
      channelSubtitle: count => `${count} 条 · 所有人都看得到`,
      editMessage: '编辑消息',
      expandMessage: '展开消息',
